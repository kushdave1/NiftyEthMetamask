...
export declare const useWeb3ExecuteFunction: (params?: Web3ExecuteFunctionParameters | undefined, options?: UseWeb3ExecuteFunctionOptions | undefined) => {
    fetch: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("../_useResolveAsyncCall").ResolveCallOptions<unknown, Web3ExecuteFunctionParameters>) => Promise<void>;
    isFetching: boolean;
    isLoading: boolean;
    error: Error | null;
    data: unknown;
