...
export declare const useWeb3Transfer: (params?: Web3TransferParameters | undefined, options?: UseWeb3TransferOptions | undefined) => {
    fetch: ({ throwOnError, onComplete, onError, onSuccess, params: fetchParams, }?: import("../_useResolveAsyncCall").ResolveCallOptions<unknown, Web3TransferParameters>) => Promise<void>;
    isFetching: boolean;
    isLoading: boolean;
    error: Error | null;
    data: unknown;
